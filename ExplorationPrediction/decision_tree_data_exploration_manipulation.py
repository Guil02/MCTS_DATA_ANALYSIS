...
columns_to_drop = ["GameRulesetName", "Id","agent1_Expansion","agent1_Play-out","agent2_Expansion","agent2_Play-out", "utility_agent2"]
...
df.to_csv("DecisionTreeExploration/filtered_file_Exploration.csv", index=False)
