...
columns_to_drop = ["GameRulesetName", "Id","agent1_Exploration","agent1_Play-out","agent2_Exploration","agent2_Play-out", "utility_agent2"]
...
df.to_csv("DecisionTreeExpansion/filtered_file_Expansion.csv", index=False)
